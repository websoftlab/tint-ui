...
import { _createSourceFile, _getQuoteChar } from "./update-tailwind-config";
...
export async function transformTailwindContent(input: string, content: string[], config: Config) {
